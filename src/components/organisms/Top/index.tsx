      ...
      <div className={style.Top__text}>
        ...
        <div className={style.Top__textBody}>
          ...
          <p className={style.Top__textJa}>
            かつて、大切なものを失う際の悲しさを、「その記憶自体を忘れること」で前に進んだ人は多いのではないだろうか。破れるほど読んだ絵本や、睡眠時間を削って聞いた音楽、多くの時間を共に過ごした恋人のような、自分だけにとって、しかし非常に大切だと思えるものを。僕たちはどうしたって忘れてしまうが、人は忘れる生き物であるという事実を、あまりにも当然のこととして受け入れ過ぎている。大切に思っていたという気持ちの記録は、どこにも残らず過去の遺物となり、やがて遺物となったことすらも忘れ去られていく。忘れることが良いことだという論調を耳にする機会は、現代では、本当に枚挙にいとまがない。本当に、忘れてしまってよいのだろうか。あったはずのものがなくなったことや、居たはずの人がいないこと、好きだったものに何も感じなくなったこと。そんな、自分だけが大切に想ってきたことに気づける写真を、残しておきたいと考えている。
          </p>
        </div>
      </div>
